...
@Component({
  selector: 'ngx-capital',
  templateUrl: './price-capital.component.html',
  providers: [FetchDataEditService2],
})
export class PriceCapitalComponent {
  dataSourceRefRatePrice: any = {};
  editing = {};
  cardheader = "Bond Price Capital";
  key = "bond-price-capital";
  private url: string = 'Theodore/bondpricecapital';
