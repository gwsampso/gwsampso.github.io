...
@Component({
  selector: 'ngx-competitive',
  templateUrl: './trade-competitive.component.html',
  providers: [FetchDataEditService2],
})
export class TradeCompetitiveComponent {
  dataSourceRefRatePrice: any = {};
  editing = {};
  cardheader = "Bond Trade Competitive";
  key = "bond-trade-competitve";
  private url: string = 'Theodore/bondtradecompetitive';
