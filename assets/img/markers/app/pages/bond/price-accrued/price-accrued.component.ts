...
@Component({
  selector: 'ngx-accrued',
  templateUrl: './price-accrued.component.html',
  providers: [FetchDataEditService2],
})
export class PriceAccruedComponent {
  dataSourceRefRatePrice: any = {};
  editing = {};
  cardheader = "Bond Price Accrued";
  key = "bond-price-accrued";
  private url: string = 'Theodore/bondpriceaccrued';
