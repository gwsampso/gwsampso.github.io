...
import { BondMaster } from '../../../@core/utils/theodore-interfaces'
...
export class MasterComponent {
  dataSourceBondMaster: any = {};
  editing = {};
  cardheader = "Bond Master";
  key = "bond-master";
  private url: string = 'Theodore/bondmaster';
  ...
  Initalize() {   
    ...
    this.dataSourceBondMaster = new DataSource({
      store: myStore
    });
