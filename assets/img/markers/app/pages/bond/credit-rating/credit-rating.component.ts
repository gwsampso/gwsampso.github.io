...
// import { FuturePrice } from '../../../@core/utils/theodore-interfaces'
...
export class CreditRatingComponent {
  dataSourceFuturePrice: any = {};
  editing = {};
  cardheader = "Credit Rating";
  key = "credit-rating";
  private url: string = 'Theodore/bondcreditrating';
  ...
  Initalize() {   
    ...
    this.dataSourceFuturePrice = new DataSource({
      store: myStore
    });
