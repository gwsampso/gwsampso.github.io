...
@Component({
  selector: 'ngx-price-yield',
  templateUrl: './price-yield.component.html',
  providers: [FetchDataEditService2],
})
export class PriceYieldComponent {
  dataSourceRefRatePrice: any = {};
  editing = {};
  cardheader = "Bond Price Yield";
  key = "bond-price-yield";
  private url: string = 'Theodore/bondpriceyield';
