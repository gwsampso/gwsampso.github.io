...
@Component({
  selector: 'ngx-maturity',
  templateUrl: './trade-maturity.component.html',
  providers: [FetchDataEditService2],
})
export class TradeMaturityComponent {
  dataSourceRefRatePrice: any = {};
  editing = {};
  cardheader = "Bond Trade Maturity";
  key = "bond-trade-maturity";
  private url: string = 'Theodore/bondtradematurity';
