...
import { OptionMaster } from '../../../@core/utils/theodore-interfaces'
...
@Component({
  selector: 'ngx-option-master',
  templateUrl: './option-master.component.html',
  providers: [FetchDataEditService2],
})
export class OptionMasterComponent {
  dataSourceOptionMaster: any = {};
  editing = {};
  private url: string = 'Theodore/optionmaster';
  ...
  Initalize() {   
    ...
    this.dataSourceOptionMaster = new DataSource({
      store: myStore
    });
