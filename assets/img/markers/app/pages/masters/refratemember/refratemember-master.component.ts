...
import { RefRateMember } from '../../../@core/utils/theodore-interfaces'
...
@Component({
  selector: 'ngx-refratemember-master',
  templateUrl: './refratemember-master.component.html',
  providers: [FetchDataEditService2],
})
export class RefRateMemberMasterComponent {
  dataSourceRefRateMemberMaster: any = {};
  editing = {};
  private url: string = 'Theodore/refratemember';
  ...
  Initalize() {   
    ...
    this.dataSourceRefRateMemberMaster = new DataSource({
      store: myStore
    });
