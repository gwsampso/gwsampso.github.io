...
import { MoneyMaster } from '../../../@core/utils/theodore-interfaces'
...
@Component({
  selector: 'ngx-money-master',
  templateUrl: './money-master.component.html',
  providers: [FetchDataEditService2],
})
export class MoneyMasterComponent {
  dataSourceMoneyMaster: any = {};
  editing = {};
  private url: string = 'Theodore/moneymaster';
  ...
  Initalize() {   
    ...
    this.dataSourceMoneyMaster = new DataSource({
      store: myStore
    });
